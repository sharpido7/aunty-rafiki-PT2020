...
class TrackerScreen extends StatelessWidget {
  ...
  final LineStyle _lineStyle=LineStyle(color:_defaultColor,thickness:2.0);
  final IndicatorStyle _indicatorStyle =IndicatorStyle(color:_defaultColor,padding: EdgeInsets.symmetric(vertical:6,horizontal:0.0),
  indicatorXY: 0.05
  );
  @override
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return TimelineTile(
          ...
          endChild: TrackerCard(trackerModel: trackers[index],),
